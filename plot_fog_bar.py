...
def main():
    parser = argparse.ArgumentParser(description='Line plot: fog density vs avg depth error (cm) and confidence with customizable σ error bars.')
    ...
    for d in data:
        ...
        print('fog_{:.1f}: mean={:.3f} cm, {:.1f}sigma={:.3f} cm{}'.format(fog_density, avg_mean, args.sigma_multiplier, args.sigma_multiplier*sigma_cm, conf_text))
